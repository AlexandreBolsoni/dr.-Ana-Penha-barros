<?php
  ...
  <div class="flex-center-row-tratamento">
    ...
    <div class="tratamento">
      ...
      <form action="CRUD/editar_tratamento.php" method="POST">
        <label for="codSessao">Codigo Da Sessão:</label>
        <input type="text" id="codSessao" name="codSessao" required><br><br>
        ...
        <a href="listaPaciente.php">Voltar</a>
      </form>
    </div>
  </div>

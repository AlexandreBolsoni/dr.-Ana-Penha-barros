...
{
    $query = "SELECT 
    sessao.codSessao AS Codigo_Sessao,
    sessao.descricao AS Descricao_Tratamento,
...
JOIN 
    ...
    if ($result) {
        ...
        <tr>
            ...
            <th>Descrição </th>
            <th>Profissional</th>
            <th>Sessões Fisioterapia</th>
            <th>Sessões Psicoterapia</th>
            <th>Total Sessões</th>
            <th>Paciente</th>
            <th>tratamento</th>
        </tr>';
        ...
        while ($row = $result->fetch_assoc()) {
            echo '<tr>';
            echo '<td>' . $row['Codigo_Sessao'] . '</td>';
            echo '<td>' . $row['Nome_Paciente'] . '</td>';
            echo '<td>' . $row['CPF'] . '</td>';
            echo '<td>' . $row['Sintomas'] . '</td>';
            echo '<td>' . $row['Descricao_Tratamento'] . '</td>';
            ...
            echo '<td><a href="edicaoCadastro.php">Editar</a></td>';
            echo '<td><a href="edicaoTratamento.php">Editar</a></td>';
            echo '</tr>';
        }
